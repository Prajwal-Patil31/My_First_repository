...
public class FaultIntegrationConfig {
    ...
    @Bean("processSeverity")
    @Qualifier("processSeverity")
    public MessageHandler FaultSeverityHandler() {
    ...
    @Bean("processClearance")
    @Qualifier("processClearance")
    public MessageHandler FaultClearanceHandler() {
        MethodInvokingMessageProcessor<FaultService> processor = new MethodInvokingMessageProcessor<>(
    ...
    @Bean("processReporting")
    @Qualifier("processReporting")
    public MessageHandler FaultReportingHandler() {
        MethodInvokingMessageProcessor<FaultService> processor = new MethodInvokingMessageProcessor<>(
    ...
    @Bean("faultProcesChain")
    @DependsOn({"processSeverity", "processClearance", "processReporting"})
    ...
    @Bean
    @DependsOn({"faultService", "faultProcesChain"})
