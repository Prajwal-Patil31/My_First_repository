...
public class NoaMain {
	...
	public class RepositoryConfig implements RepositoryRestConfigurer {
		...
		config.exposeIdsFor(UserAccount.class ,PasswordPolicy.class, Role.class, 
							Feature.class, PasswordPolicy.class, AuditInfo.class, 
							UserGroup.class, Resource.class, ResourceGroup.class,Fault.class, 
							FaultAcknowledgePolicy.class, FaultEscalatePolicy.class, FaultConfig.class
							);
	}
