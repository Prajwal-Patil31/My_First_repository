 ...
 */
package in.utl.noa.restconf.swagger;
 ...
 */
public class SwaggerNOA extends AbstractLightyModule {

    private static final Logger LOG = LoggerFactory.getLogger(SwaggerNOA.class);
    ...
    public SwaggerNOA(RestConfConfiguration restConfConfiguration,
    ...
    private void addStaticResources(ServletContextHandler mainHandler, String path, String servletName) {
        ...
        String externalResource = SwaggerNOA.class.getResource(path).toExternalForm();
